...
def create_app(test_config=None):
  ...
  def index():
      actors = [
        ...
        {"name": "Antonio Banderas", "gender": "male"},
      ...
      for actor in actors:
          new_actor = Actor(name=actor['name'], gender=actor['gender'])
          new_actor.insert()

      movies = [
        {"title": "Once Upon a Time in Hollywood", "release_date": "2020-01-01", "actors": [6, 5]},
        {"title": "Pain and Glory", "release_date": "2019-03-22", "actors": [2]},
        {"title": "Marriage Story", "release_date": "2019-11-06", "actors": [3]},
        {"title": "Joker", "release_date": "2019-10-04", "actors": [4]},
        {"title": "I, Tonya", "release_date": "2017-12-08", "actors": [6]},
        {"title": "Philadelphia", "release_date": "1993-12-22", "actors": [1]},
      ]
      ...
      for movie in movies:
          ...
          for actor in movie['actors']:
              cast = Cast(movie_id=new_movie.id,actor_id=actor)
              cast.insert()
